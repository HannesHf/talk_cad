...
Das Projekt nutzt **DeepSeek R1** (via OpenRouter) zur Generierung von Python-Code für die **build123d** CAD-Bibliothek. Das Ergebnis wird sofort als 3D-Modell im Browser visualisiert.
